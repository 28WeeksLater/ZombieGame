...
public class MeshDrawer : MonoBehaviour
{
    ...
    {
        wristSocket.selectEntered.AddListener(GetMeshFilter);
    }

    private void OnDisable()
    {
        wristSocket.selectEntered.RemoveListener(GetMeshFilter);
    }

    private void GetMeshFilter(SelectEnterEventArgs args)
    {
        interactableMeshFilter = args.interactable.GetComponent<MeshFilter>();
    }
